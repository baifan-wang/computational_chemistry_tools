...
def generate_restraint(base_pair):
    ...
    string = (res1, res2, atom_dict[res_key][0], iat, parameters, atom_dict[res_key][1], \
...
if __name__ == '__main__':
    ...
    if len(residue_list) == 0:
        ...
        for bp in residue_list:
            ...
            for i in base_pairs:
                restraint_list.append(generate_restraint(i))
    if output_file:
